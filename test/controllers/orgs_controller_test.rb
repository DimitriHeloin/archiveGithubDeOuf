...
class OrgsControllerTest < ActionController::TestCase
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post :create, org: { avatar_url: @org.avatar_url, gravatar_id: @org.gravatar_id, id: @org.id, login: @org.login, url: @org.url }
    end
  ...
  test "should update org" do
    patch :update, id: @org, org: { avatar_url: @org.avatar_url, gravatar_id: @org.gravatar_id, id: @org.id, login: @org.login, url: @org.url }
    assert_redirected_to org_path(assigns(:org))
  end
